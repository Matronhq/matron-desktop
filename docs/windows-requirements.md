...
We rely on Github Actions `windows-2022` plus a few extra utilities as per [the workflow](https://github.com/matronhq/matron-desktop/blob/develop/.github/workflows/build_windows.yaml).
