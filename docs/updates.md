...
Currently all packaging & deployment is handled by [Github actions](https://github.com/matronhq/matron-desktop/blob/develop/.github/workflows/build_and_deploy.yaml)
