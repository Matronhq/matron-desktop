...
const DEFAULT_VARIANT = path.join("matron", "release", "build.json");
...
const config: Omit<Writable<Configuration>, "electronFuses"> & {
    ...
    linux: {
        ...
        icon: "icon.png",
        executableName: variant.name, // matron-desktop or matron-desktop-nightly
    },
    deb: {
        packageCategory: "net",
        depends: [
        ...
        recommends: ["matron-archive-keyring"],
